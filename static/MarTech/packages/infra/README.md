# @play-c463-z26-rzy-mar-tech/infra

This library was generated with [@aws/nx-plugin](https://github.com/awslabs/nx-plugin-for-aws/).

## Building

Run `pnpm exec nx build @play-c463-z26-rzy-mar-tech/infra [--skip-nx-cache]` to build the application.

## Running unit tests

Run `pnpm exec nx test @play-c463-z26-rzy-mar-tech/infra` to execute the unit tests via Vitest.

### Updating snapshots

To update snapshots, run the following command:

`pnpm exec nx test @play-c463-z26-rzy-mar-tech/infra --configuration=update-snapshot`

## Run lint

Run `pnpm exec nx lint @play-c463-z26-rzy-mar-tech/infra`

### Fixable issues

You can also automatically fix some lint errors by running the following command:

`pnpm exec nx lint @play-c463-z26-rzy-mar-tech/infra --configuration=fix`

## Deploy to AWS

### Deploy all Stacks

Run `pnpm exec nx deploy @play-c463-z26-rzy-mar-tech/infra --all`

### Deploy a single Stack

Run `pnpm exec nx deploy @play-c463-z26-rzy-mar-tech/infra [stackName]`
...
Run `pnpm exec nx deploy @play-c463-z26-rzy-mar-tech/infra --hotswap --all`
